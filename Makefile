...
SOURCE_FILES := lib/build-metadata.bash lib/runtime/exit-codes.bash lib/runtime/context.bash lib/runtime/logging.bash lib/manifest/parser.bash lib/planner/action-record.bash lib/planner/planner.bash src/bootstrap.bash
