...
## @par Examples
## @code
## if ! bootstrap_backend_detect_manager >/dev/null; then
...
## @fn bootstrap_backend_diagnostic_unsupported_manager()
...
## @fn bootstrap_backend_diagnostic_missing_package_name()
...
## @fn bootstrap_backend_diagnostic_unsupported_capability()
...
## @par Examples
## @code
## bootstrap_backend_diagnostic_unsupported_capability apk compare-version
## @endcode
...
## @fn bootstrap_backend_diagnostic_package_unavailable()
...
## @fn bootstrap_backend_diagnostic_no_candidate()
...
##   bootstrap_backend_diagnostic_no_candidate apt old-package
## fi
## @endcode
...
## @fn bootstrap_backend_diagnostic_unsupported_version_operator()
...
## @par Examples
## @code
## bootstrap_backend_diagnostic_unsupported_version_operator apt "<="
## @endcode
...
## @fn bootstrap_backend_diagnostic_missing_version()
...
## version=""
## if [[ -z "${version}" ]]; then
##   bootstrap_backend_diagnostic_missing_version apt curl ">="
## fi
## @endcode
...
## @fn bootstrap_backend_diagnostic_unsatisfied_version_constraint()
