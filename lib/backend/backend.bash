...
## @par Examples
## @code
## manager="$(bootstrap_backend_detect_package_manager)"
...
## @par Examples
## @code
## if bootstrap_backend_supports_capability apt version-constraints; then
##   printf 'APT can evaluate version constraints\n'
## fi
## @endcode
...
## @par Examples
## @code
## if bootstrap_backend_package_exists apt curl; then
##   printf 'curl is available through APT\n'
## fi
## @endcode
