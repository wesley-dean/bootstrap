...
##   printf 'APT backend is available\n'
## fi
## @endcode
...
## @par Examples
## @code
## if bootstrap_backend_apt_package_exists curl; then
##   printf 'curl can be planned for APT\n'
## fi
## @endcode
...
## @par Examples
## @code
## candidate="$(bootstrap_backend_apt_candidate_version curl)" || exit "$?"
## printf 'APT would install curl version: %s\n' "${candidate}"
## @endcode
...
## @par Examples
## @code
## dpkg_operator="$(bootstrap_backend_apt_dpkg_operator '>=')" || exit "$?"
## dpkg --compare-versions 1.2 "${dpkg_operator}" 1.0
## @endcode
...
## @par Examples
## @code
## if bootstrap_backend_apt_package_satisfies_version curl '>=' 7.0; then
##   printf 'curl satisfies the requested APT constraint\n'
## fi
## @endcode
