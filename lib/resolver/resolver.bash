...
##   install-package curl '' '' packages.txt 1 auto
## printf 'install-package|curl|||packages.txt|1\n' |
##   bootstrap_resolver_resolve_action_records auto
## @endcode
...
## @par Examples
## @code
## manager="$(bootstrap_resolver_detect_package_manager)"
...
## @fn bootstrap_resolver_resolve_action_record()
...
## @code
## bootstrap_resolver_resolve_action_record \
##   install-package curl '' '' packages.txt 1 apt
## @endcode
bootstrap_resolver_resolve_action_record() {
  local action
  local line_number
...
## @fn bootstrap_resolver_resolve_action_records()
