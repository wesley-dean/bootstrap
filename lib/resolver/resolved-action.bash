...
## @par Examples
## @code
## bootstrap_resolved_action_create_install_package apt curl "" "" packages.txt 3
## @endcode

## @fn bootstrap_resolved_action_create_install_package()
...
## @code
## bootstrap_resolved_action_create_install_package apt curl "" "" packages.txt 3
## bootstrap_resolved_action_create_install_package apt bash ">=" "5.0" packages.txt 4
## @endcode
