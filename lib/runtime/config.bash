...
## @par Examples
## @code
## trimmed="$(bootstrap_config_trim "  apt  ")"
## printf "%s\n" "${trimmed}"
## @endcode
...
## @par Examples
## @code
## value="$(bootstrap_config_unquote "\"apt\"")"
## printf "%s\n" "${value}"
## @endcode
...
## @fn bootstrap_config_apply_assignment()
...
## @par Examples
## @code
## bootstrap_config_apply_assignment BOOTSTRAP_PACKAGE_MANAGER apt .env 1
## @endcode
...
## @par Examples
## @code
## BOOTSTRAP_PACKAGE_MANAGER=apt bootstrap_config_apply_environment
## @endcode
...
## @par Examples
## @code
## bootstrap_config_validate_package_manager apt
## @endcode
