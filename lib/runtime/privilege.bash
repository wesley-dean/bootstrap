...
## @par Examples
## @code
## uid="$(bootstrap_privilege_effective_uid)"
...
## @par Examples
## @code
## prefix="$(bootstrap_privilege_command_prefix)" || exit "$?"
## printf 'privilege prefix: %s\n' "${prefix:-none}"
## @endcode
...
## @par Examples
## @code
## bootstrap_privilege_run apt-get install -y shellcheck
## @endcode
