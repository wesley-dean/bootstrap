...
- Native package-manager delegation, starting with APT.
...
small, reviewable package-manifest workflow with an APT backend. Additional
package-manager backends and richer provisioning features are future work.
